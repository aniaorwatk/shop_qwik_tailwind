...
import { ITypeRoot, MyContext } from '~/root';
  ...
  return (
    <div class="flex flex-1 flex-col">
      <section class="min-h-screen flex relative">
        <img src="https://www.as.cmielow.com.pl/5291/filizanka-lena-do-herbaty.jpg" alt="cup-home-page" class="object-cover w-full" />
